...
class _RespostaDropdownState extends State<RespostaDropdown> {
  ...
  Widget build(BuildContext context) {
    ...
    _escolha = _escolha ?? widget.autoPreencher ?? widget.pergunta.respostaNumerica?.toInt();
            ...
            child: DropdownButtonFormField(
              ...
              onChanged: (String? value) {
                setState(() {
                  ...
                  widget.pergunta.setRespostaNumerica(_escolha ?? 0);
                });
                widget.notificarParent!();
              },
              onSaved: (value) {
                widget.pergunta.setRespostaNumerica(_escolha);
              },
