...
import 'package:sono/pages/avaliacao/questionarios/pittsburg/questionario/widgets/multipla_custom_pittsburg.dart';
import 'package:sono/pages/avaliacao/questionarios/pittsburg/questionario/widgets/resposta_horario_pittsburg.dart';
...
class PittsburgController {
  ...
  void _filtrarPerguntasCondicionais() {
    if (_perguntas
            .firstWhere((element) => element.codigo == "10")
            .respostaNumerica ==
        0) {
      ...
      for (Pergunta pergunta in _perguntas.where(
        ...
        pergunta.setRespostaNumerica(0);
