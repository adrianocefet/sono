...
class ResultadoPittsburg {
  ...
  int get _pontuacaoComponente1 => perguntas
      .firstWhere((pergunta) => pergunta.codigo == "6")
      .respostaNumerica!
      .toInt();
  ...
  int get _pontuacaoComponente2 {
    ...
    int soma = q5A.respostaNumerica!.toInt() + pontuacaoQ2;
  ...
  int get _pontuacaoComponente5 {
    ...
    for (Pergunta pergunta in perguntas
      ...
      soma5Ba5J += pergunta.respostaNumerica?.toInt() ?? 0;
    }
  ...
  int get _pontuacaoComponente6 => perguntas
      .firstWhere((pergunta) => pergunta.codigo == "7")
      .respostaNumerica!
      .toInt();

  int get _pontuacaoComponente7 {
    int respostaq8 = perguntas
        .firstWhere((element) => element.codigo == "8")
        .respostaNumerica!
        .toInt();
    int respostaq9 = perguntas
        .firstWhere((element) => element.codigo == "9")
        .respostaNumerica!
        .toInt();
