...
class PainelHistorico extends StatefulWidget {
  ...
  const PainelHistorico({Key? key,required this.idSolicitacao}) : super(key: key);
                            ...
                            StreamBuilder<DocumentSnapshot<Map<String,dynamic>>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListTile(
                                  ...
                                  subtitle: Text("CPF: ${pacienteSolicitado.cpf??'Não informado!'}"),
                      ...
                      Padding(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed:solicitacao.urlPdf!=null?()async{
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>TelaPDF(arquivo: arquivo)));
                          }:null,
                          label: Text(solicitacao.tipo==TipoSolicitacao.emprestimo?"Ver termo de responsabilidade":"Ver documento de devolução",style: TextStyle(color: Colors.black),)),
                      ),
                ],
                ),
            ),
