...
Future adicionarObservacao(BuildContext context,Equipamento equipamento)async{
                      ...
                      child: TextFormField(
                        ...
                        validator: (value){
                          if(value!.isNotEmpty && value.length>5){
                            ...
                            return 'Digite uma observação mais detalhada!';
                    ...
                    child: ElevatedButton(
                      onPressed: (){
                        if(_formKey.currentState!.validate()){
                          ...
                          try{
                            equipamento.infoMap['observacao']=_Textcontroller.value.text;
