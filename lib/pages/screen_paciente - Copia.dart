...
class _ScreenPacienteState extends State<ScreenPaciente> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('Paciente').doc(ID).snapshots()
        ...
        builder: (context, snapshot) {
          switch (snapshot.connectionState) {
            ...
            default:
              return Scaffold(
                  appBar: AppBar(
                    title: Text(respostas['Nome'] ?? 'sem nome'), //Text(snapshot.data!['Nome']),
                    actions: [
                      IconButton(
                          onPressed: (){
                            setState(() {
                              model.editar ? model.editar = false : model.editar = true;
                            });
                            if (model.editar) {
                          ...
                          icon: model.editar ? Icon(Icons.edit) : Icon( Icons.save)
                      )
                    ],
                  ),
                  body: Column(
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Image.network(
                                    respostas['Foto'] ?? model.semimagem,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    model.editar
                                        ...
                                        : questao('IH'),
                                    model.editar
                                        ? questao1('Índice de apneia central')
                                        : questao('Índice de apneia central'),
                                    model.editar
                                        ? questao1('Índice de apneia obstrutiva')
                                        : questao('Índice de apneia obstrutiva'),
                                    model.editar
                                        ? questao1('Índice de apneia desconhecida')
                                        : questao('Índice de apneia desconhecida'),
                                    model.editar
                                        ? questao1('RERA')
                                        : questao('RERA'),
                                    model.editar
                                        ? questao1('Respiração de Cheyne-Stockes')
                                        : questao('Respiração de Cheyne-Stockes'),
                                  ],
                                ),
                              ),
                            ],
